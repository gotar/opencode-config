...
4. **Framework-Specific Issues**
    ...
    - Rails: N+1 queries, inefficient ActiveRecord usage, missing caching, improper Turbo frame/stream usage, not using SQLite WAL mode, external JS/CSS frameworks instead of importmap/pure CSS, missing service objects in app/services/, fat controllers violating thin controller principle
    - Database: N+1 queries, missing indexes
    - Frontend: bundle size, asset optimization, Stimulus controller inefficiencies
...
4. **Maintainability Issues**
    ...
    - Rails: fat controllers/models, violation of single responsibility, improper use of concerns/services
