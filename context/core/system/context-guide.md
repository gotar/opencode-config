...
**Index Location**: `/home/gotar/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/home/gotar/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/home/gotar/.config/opencode/context/core/` with organized subfolders:

### Standards (Quality Guidelines + Analysis)
- `standards/code.md` - Rails code patterns and conventions [critical]
- `standards/docs.md` - Documentation standards [critical]
- `standards/tests.md` - Rails testing with fixtures and real database [critical]
- `standards/patterns.md` - Rails-specific patterns and anti-patterns [high]
...
- `workflows/task-breakdown.md` - Rails task breakdown with Hotwire examples [high]
...
- Load `/home/gotar/.config/opencode/context/index.md`
...
### /home/gotar/.config/opencode/context/core/standards/code.md
- Writing new Rails code
- Modifying existing Rails code
- Following Rails conventions and 37signals patterns
- Making Rails architectural decisions

### /home/gotar/.config/opencode/context/core/standards/docs.md
- Writing README files
- Creating API documentation
- Adding code comments

### /home/gotar/.config/opencode/context/core/standards/tests.md
- Writing Rails tests with fixtures
- Running Rails test suites
- Debugging Rails test failures
- Testing real database state

### /home/gotar/.config/standards/patterns.md
- Rails concern composition
- Transaction safety patterns
- Event tracking patterns
- Strong parameters validation

### /home/gotar/.config/opencode/context/core/standards/analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /home/gotar/.config/opencode/context/core/workflows/delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /home/gotar/.config/opencode/context/core/workflows/task-breakdown.md
- Rails features with models, controllers, views
- Hotwire implementation tasks
- Database migrations and schema changes
- Complex Rails dependencies

### /home/gotar/.config/opencode/context/core/workflows/sessions.md
- Session lifecycle
- Cleanup procedures
- Session isolation

### /home/gotar/.config/opencode/context/core/workflows/review.md
- Reviewing code
