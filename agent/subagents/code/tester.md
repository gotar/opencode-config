...
- For Rails projects: use Minitest conventions (not RSpec), Rails fixtures over FactoryBot, include model, controller, integration, and system tests; test Turbo/Stimulus interactions with Capybara + Turbo.
- Author and run appropriate tests (bun for JS, rails test for Rails) for the code before handoff.
